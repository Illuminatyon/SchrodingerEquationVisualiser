"""
Custom Matplotlib style for the Schrödinger equation solver.
...
def set_mpl_theme():
    ...
    """
    # Define quantum physics inspired color scheme
    background_color = '#121212'  # Dark background (space-like)
    text_color = '#F5F5F5'        # Light text for readability
    grid_color = '#00796B'        # Teal for grid (wave function)
    accent_color = '#FFA000'      # Amber for accents (energy)
    ...
    style_dict = {
        ...
        'font.family': 'serif',
        'font.serif': ['Computer Modern Roman', 'CMU Serif', 'Times New Roman', 'DejaVu Serif', 'Bitstream Vera Serif', 'serif'],
    ...
    # Quantum physics inspired colormap
    # Create a list of (position, color) pairs in the correct format for LinearSegmentedColormap
    primary_blue = '#1A237E'  # Deep blue (quantum realm)
    secondary_purple = '#7B1FA2'  # Purple (quantum superposition)
    accent_cyan = '#00E5FF'  # Bright cyan (highlighting)
    
    # Convert hex colors to RGB tuples
    blue_rgb = mpl.colors.to_rgb(primary_blue)
    teal_rgb = mpl.colors.to_rgb(grid_color)
    purple_rgb = mpl.colors.to_rgb(secondary_purple)
    amber_rgb = mpl.colors.to_rgb(accent_color)
    cyan_rgb = mpl.colors.to_rgb(accent_cyan)
